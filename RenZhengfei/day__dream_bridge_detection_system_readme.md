...
1. clone仓库或下载并解压ZIP文件
2. Eclipse导入
bridge_detection_system后端项目文件夹
3. Mysql数据库执行
BridgeDetection.sql查询
4. Eclipse更改Spring配置文件（关于数据库用户信息）
5. Eclipse启动Tomcat服务器（服务器端口为8081）
6. 进入bridge-admin文件夹命令行，
7. 执行 `npm run dev` 命令，启动项目前端
...
[本文转自如下链接](http://u.720life.cn/g/2e71d0f0a5c601172267ba20d3a43c6e92370e233005ad474387281d8a3b455c80100cbaec7230ab9c563416de3ff9b552cf174bc9945bc270d5a4b03226c621a6e2f6237ca42c6dba06977c6c5b456c)