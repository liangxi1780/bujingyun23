...
```
  ./build.sh [-o  ] [-c  ] [-n  ] [-d] [-e] [-x] [-h]

         -o     Build OpenSSL version (default 1.1.1d)
         -c     Build curl version (default 7.68.0)
         -n     Build nghttp2 version (default 1.40.0)
...
[本文转自如下链接](http://u.720life.cn/g/2e71d0f0a5c601172267ba20d3a43c6ee3153dd98f3891a22d07923f34e2613ce8392d8d732d6ac6f5c39d5e39ffd78ce60c270d0a6876c7ed24a73d21c2a0d6ee86a0cd8b9e404fd9f2bc46ceb30036)