...
## 【项目概述】
[**EasyWebApp**](http://u.720life.cn/g/b197da7895d2931dc58e231b1d5917b308dbbbc7a1d141b846e08e4dc3de59a9747425d5c55d7c656dbf031b2d25ef3d) 是一个基于 **jQuery API** 的 **轻量级 SPA（单页应用）引擎**， **网页设计、后端接口、前端组件 充分解耦** —— 只用 **原生 HTML** 做模板，对 **JSON 数据**的结构几无硬性要求，完全兼容现有的 **jQuery 插件**。

本引擎广泛使用的最新开源稳定版 v2.5 脱胎于 3 个 **移动端网页应用**（微信公众平台）和 3 个 **桌面端网页系统**（某公司开放平台），是一个有较高 **抽象性**、 **普适性**的 SPA 引擎， **个人独立开发**、 **团队协作开发** 都能轻松胜任~


## 【核心理念】
EasyWebApp 与其作者开发的 [**EasyWebUI**](http://u.720life.cn/g/5c954f4cd4204fb6c09a7e58aa70844dc874ac2947d5b6fe66d9ed043a38905ee6d98d21b60bf147fda64a0f7e7aa1e9)（Web 前端 UI 框架）的理念一致 ——
...
### 一、每日资讯（移动版）
 ...
 - 后端数据
   - 引用了 **淘宝网 IP 地理信息**、[**天狗云平台**](http://u.720life.cn/g/af6bb18f363c32296c3329db21bd1be07d3a1089655ad8f33eab2b02f3822957) 的开放 API

### 二、后台管理 UI
 - 前端页面
   - 访问网址：http://tech_query.oschina.io/easywebapp/demo/Admin/
 - 后端数据
   - 主要基于 [**天狗云平台**](http://u.720life.cn/g/af6bb18f363c32296c3329db21bd1be07d3a1089655ad8f33eab2b02f3822957) 的开放 API
...
## 【版本历史】
 ...
 - v2.2   Stable —— 2015年12月3日  引擎内部实现 **OOP 重构**（第二阶段）
   ...
   - ListView 实现独立为一个 jQuery 静态方法，并贡献给 iQuery 项目的 [iQuery+ 插件库](http://u.720life.cn/g/5c954f4cd4204fb6c09a7e58aa70844dc874ac2947d5b6fe66d9ed043a38905e0551704eae226b5acd83cb92d3a2ca2f075ddc8709a9e085bc065e69458eed18)
...
本项目的开发最早基于 [**iQuery**](http://u.720life.cn/g/5c954f4cd4204fb6c09a7e58aa70844dc874ac2947d5b6fe66d9ed043a38905eb94a1984d55277d63750a150cf5e820d)（相当于 **jQuery v1.x** 的精简与扩展），若要用 **jQuery 官方版**来驱动本引擎，需要同时加载 iQuery 项目中的 [jQuery+.js](http://u.720life.cn/g/5c954f4cd4204fb6c09a7e58aa70844dc874ac2947d5b6fe66d9ed043a38905e0551704eae226b5acd83cb92d3a2ca2f135cd346c7b2c0706ec5683863f5e84c) 来启用扩展的 jQuery API（一些 jQuery 插件）。

本引擎 v1.3 开始支持的 **MarkDown 规范代码渲染** 还需要加载 [**marked.js**](http://u.720life.cn/g/54145d0471d91890860f7f8463c030464877b289699bd26f51b6238ab525a8eb)（推荐引用 [中国大陆 CDN](http://u.720life.cn/g/5dc63d04a35b84846e193be705862c77278bc91f27041c050d13d98860b33f67)）。
...
```
【注】上述代码中的 `$.paramJSON()`、`$.paramSign()` 来自 [**iQuery**](http://u.720life.cn/g/5c954f4cd4204fb6c09a7e58aa70844dc874ac2947d5b6fe66d9ed043a38905eb94a1984d55277d63750a150cf5e820d)。
...
## 【项目缘起】
**EasyWebApp** 算是其作者与 产品、设计、后端的各种“撕逼”后，或坚持、或折中的结果。其 **HTML 模板机制** 源于作者早期的一个 PHP 前端项目 [EasyWebTemplate](http://u.720life.cn/g/5c954f4cd4204fb6c09a7e58aa70844dc874ac2947d5b6fe66d9ed043a38905ef4d7aa9ca457bdbc13212502de6f6cb32db1855db8a60f0dd5a8e3810bbead78)（基于 **phpQuery**），而其 **事件驱动的 API** 则源于文首提到的开放平台首个版本的 **智能表单引擎** JSON_Web.js（强数据格式依赖、不支持不规律的界面设计，未到达开源水准，但会继续吸收其优秀的特性）。虽然前面这些小项目 都有些幼稚，但却又是 **敢于把独立思考成果付诸实践**的有益尝试，若没有这些沉淀，就没有本项目自 2015年6月29日的26天 内即发布 **开源稳定版**的成绩~
...
[本文转自如下链接](http://u.720life.cn/g/2e71d0f0a5c601172267ba20d3a43c6eff9244119a88cb7988d7c93f0b9934883932a1a280fe375fd0c9af45ad8eda2e9be7f5b7df6d33c9addec2b3cb4b9387)