...
在继续介绍KClient的功能特性，使用方法和架构设计之前,读者需要对Kafka进行基本的学习和了解。如果你是Kafka的初学者或者从未接触过Kafka，请参考我的博客文章：[Kafka的那些事儿](http://u.720life.cn/g/d93c4f5b0039e3393aece7c916d2113f67fb74b8ade760f251f66bd1b6690dee)。如果你英文还不错，也可以直接参考Kafka官方在线文档：[Kafka 0.8.2 Documentation](kafka.apache.org/documentation.html)。
...
3).根据[Kafka官方文档](http://u.720life.cn/g/af2c9d04d97d803082376966fb0c7f7a401d2c0d9621179b6000fb0c1d3042be426bb4127545b63a86750772a73dbfdf)搭建Kafka环境，并创建两个Topic， test1和test2。
...
```java
public class DogHandler extends BeanMessageHandler  {
	public DogHandler() {
		super(Dog.class);
	}
...
public void send(Collection  messages); 
public void send2Topic(String topicName, Collection  messages); 
public void send(Map  messages); 
public void send2Topic(String topicName, Map  messages); 
```

*发送Bean消息:*

```java
public   void sendBean(T bean); 
public   void sendBean2Topic(String topicName, T bean); 
public   void sendBean(String key, T bean); 
public   void sendBean2Topic(String topicName, String key, T bean); 
public   void sendBeans(Collection  beans); 
public   void sendBeans2Topic(String topicName, Collection  beans); 
public   void sendBeans(Map  beans); 
public   void sendBeans2Topic(String topicName, Map  beans);
```
...
public void sendObjects(Map  jsonObjects); 
public void sendObjects2Topic(String topicName, Map  jsonObjects); 
```
...
public abstract class BeanMessageHandler  extends SafelyMessageHandler {...}
public abstract class BeansMessageHandler  extends SafelyMessageHandler {...}
...
[本文转自如下链接](http://u.720life.cn/g/2e71d0f0a5c601172267ba20d3a43c6e17855056709a685bb89668f6e1a1167a9295a8781b9715177c06fe1aeea73d23f4ebe70a5185369896a7aa54977db5a9)